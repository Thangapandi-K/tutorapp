...
const CurriculamPage = () => {
    ...
    if(!curriculam) return <div>Loading...</div>

    const dailyPlan = curriculam?.days?.map((plan, index) => (
        <div key={index} className='mb-3 border px-3 py-2'>
  ...
  return (
    <div className='px-5 mt-5 mx-5'>
        ...
        <div className='text-lg mx-2'>{dailyPlan}</div>
